...
class Test_Fieldmanager_Datasource_User extends WP_UnitTestCase {
	...
	public function test_reciprocal_meta() {
		$reciprocal = new Fieldmanager_Autocomplete(
			array(
	...
	public function test_store_properties() {
		...
		$store_id = new Fieldmanager_Autocomplete(
			array(
				'name'       => 'test_store_id',
				'datasource' => new Fieldmanager_Datasource_User(
					array(
		...
		$store_user_login = new Fieldmanager_Autocomplete(
			array(
		...
		$store_user_email = new Fieldmanager_Autocomplete(
			array(
		...
		$store_user_nicename = new Fieldmanager_Autocomplete(
			array(
	...
	public function test_display_properties() {
		...
		$test_display_name = new Fieldmanager_Autocomplete(
			array(
		...
		$test_user_login = new Fieldmanager_Autocomplete(
			array(
		...
		$test_user_email = new Fieldmanager_Autocomplete(
			array(
		...
		$test_user_nicename = new Fieldmanager_Autocomplete(
			array(
	...
	public function test_store_property_display() {
		...
		$test_id = new Fieldmanager_Autocomplete(
			array(
				'name'       => 'test_display_name',
				'datasource' => new Fieldmanager_Datasource_User(
					array(
