...
class Fieldmanager_Context_Page extends Fieldmanager_Context {
	...
	public function render_page_form() {
		...
		printf( '<input type="hidden" name="fm-page-action" value="%s" />', esc_attr( sanitize_title( $this->uniqid ) ) );
		wp_nonce_field( 'fieldmanager-save-' . $this->fm->name, 'fieldmanager-' . $this->fm->name . '-nonce' );
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- HTML markup generated by element_markup()
