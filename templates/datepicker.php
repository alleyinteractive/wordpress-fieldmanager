...
<?php
// Render only if no user-supplied options already exist.
if ( empty( $this->js_opts['altField'] ) && empty( $this->js_opts['altFormat'] ) ) :
	include fieldmanager_get_template( 'datepicker-altfield' );
endif;
?>
